#include "modbus_n4d3xxx.h"
#include "esphome/core/application.h"
#include "esphome/core/log.h"

namespace esphome {
namespace modbus_n4d3xxx {

static const char *const TAG = "modbus_n4d3xxx";

void N4D3XXXController::setup() {
  // Modbus::setup();
...
*/
bool N4D3XXXController::send_next_command_() {
...
void N4D3XXXController::on_modbus_data(const std::vector<uint8_t> &data) {
...
void N4D3XXXController::process_modbus_data_(const ModbusCommandItem *response) {
...
void N4D3XXXController::on_modbus_error(uint8_t function_code, uint8_t exception_code) {
...
SensorSet N4D3XXXController::find_sensors_(ModbusRegisterType register_type, uint16_t start_address) const {
...
void N4D3XXXController::on_register_data(ModbusRegisterType register_type, uint16_t start_address,
...
void N4D3XXXController::queue_command(const ModbusCommandItem &command) {
...
void N4D3XXXController::update_range_(RegisterRange &r) {
...
size_t N4D3XXXController::create_register_ranges_() {
...
void N4D3XXXController::dump_config() {
  ESP_LOGCONFIG(TAG, "N4D3XXXController:");
...
void N4D3XXXController::on_write_register_response(ModbusRegisterType register_type, uint16_t start_address,
                                                  const std::vector<uint8_t> &data) {
  ESP_LOGV(TAG, "Command ACK 0x%X %d ", get_data<uint16_t>(data, 0), get_data<int16_t>(data, 1));
}

void N4D3XXXController::dump_sensors_() {
...
ModbusCommandItem ModbusCommandItem::create_read_command(
    N4D3XXXController *modbusdevice, ModbusRegisterType register_type, uint16_t start_address, uint16_t register_count,
...
ModbusCommandItem ModbusCommandItem::create_read_command(N4D3XXXController *modbusdevice,
...
ModbusCommandItem ModbusCommandItem::create_write_multiple_command(N4D3XXXController *modbusdevice,
...
ModbusCommandItem ModbusCommandItem::create_write_single_coil(N4D3XXXController *modbusdevice, uint16_t address,
                                                              bool value) {
  ModbusCommandItem cmd;
  cmd.modbusdevice = modbusdevice;
...
ModbusCommandItem ModbusCommandItem::create_write_multiple_coils(N4D3XXXController *modbusdevice, uint16_t start_address,
...
ModbusCommandItem ModbusCommandItem::create_write_single_command(N4D3XXXController *modbusdevice, uint16_t start_address,
                                                                 uint16_t value) {
  ModbusCommandItem cmd;
  cmd.modbusdevice = modbusdevice;
  cmd.register_type = ModbusRegisterType::HOLDING;
...
ModbusCommandItem ModbusCommandItem::create_custom_command(
    N4D3XXXController *modbusdevice, const std::vector<uint8_t> &values,
    std::function<void(ModbusRegisterType register_type, uint16_t start_address, const std::vector<uint8_t> &data)>
        &&handler) {
  ModbusCommandItem cmd;
  cmd.modbusdevice = modbusdevice;
...
ModbusCommandItem ModbusCommandItem::create_custom_command(
    N4D3XXXController *modbusdevice, const std::vector<uint16_t> &values,
    std::function<void(ModbusRegisterType register_type, uint16_t start_address, const std::vector<uint8_t> &data)>
        &&handler) {
  ModbusCommandItem cmd = {};
  cmd.modbusdevice = modbusdevice;

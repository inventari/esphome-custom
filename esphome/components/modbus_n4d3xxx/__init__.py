...
modbus_n4d3xxx_ns = cg.esphome_ns.namespace("modbus_n4d3xxx")
N4D3XXXController = modbus_n4d3xxx_ns.class_(
    "N4D3XXXController", cg.PollingComponent, modbus.ModbusDevice
)

SensorItem = modbus_n4d3xxx_ns.struct("SensorItem")

ModbusFunctionCode_ns = modbus_n4d3xxx_ns.namespace("ModbusFunctionCode")
...
ModbusRegisterType_ns = modbus_n4d3xxx_ns.namespace("ModbusRegisterType")
...
SensorValueType_ns = modbus_n4d3xxx_ns.namespace("SensorValueType")
...
CONFIG_SCHEMA = cv.All(
    cv.Schema(
        {
            cv.GenerateID(): cv.declare_id(N4D3XXXController),
            cv.Optional(

...
// N4D3XXXController::create_register_ranges_ tries to optimize register range
...
class ModbusCommandItem {
 public:
  ...
  N4D3XXXController *modbusdevice;
   ...
   * @return ModbusCommandItem with the prepared command
   */
  static ModbusCommandItem create_read_command(N4D3XXXController *modbusdevice, ModbusRegisterType register_type,
   ...
   * @return ModbusCommandItem with the prepared command
   */
  static ModbusCommandItem create_write_multiple_command(N4D3XXXController *modbusdevice, uint16_t start_address,
   ...
   * @return ModbusCommandItem with the prepared command
   */
  static ModbusCommandItem create_write_single_command(N4D3XXXController *modbusdevice, uint16_t start_address,
                                                       uint16_t value);
   ...
   * @return ModbusCommandItem with the prepared command
   */
  static ModbusCommandItem create_write_single_coil(N4D3XXXController *modbusdevice, uint16_t address, bool value);
   ...
   * @return ModbusCommandItem with the prepared command
   */
  static ModbusCommandItem create_write_multiple_coils(N4D3XXXController *modbusdevice, uint16_t start_address,
 ...
 * when esphome calls N4D3XXXController::Update the commands for each range are created and sent
 * Responses for the commands are dispatched to the modbus sensor items.
 */

class N4D3XXXController : public PollingComponent, public modbus::ModbusDevice {
 public:
